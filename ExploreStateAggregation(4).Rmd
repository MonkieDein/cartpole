...
angle_i_state = matrix(0,Splitstate,)
for (i in 1:Splitstate){
  angle_i = runif(n_set,PoleAngleQuantile[i],PoleAngleQuantile[i+1])
  angle_mat = matrix(c(rep(angle_i,(n_var-1)),rep(1,n_set)),n_set,n_var) # 1000 by 4
