...
```{r}
# ExpectedRew = CondtionAngle/abs(PoleAngleQuantile) -abs(CartPosQuantile) 
# 
# ExpectedRew = ExpectedRew[-which(ExpectedRew==Inf)]
# ExpectedRew = rep(c(t(matrix(rep(ExpectedRew,100),10,100))),10) 
