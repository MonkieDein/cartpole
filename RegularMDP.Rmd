...
CartPosQuantile  = quantile(df$CartPos,(0:10)*0.1)
# Discretize state as 10 differnt quantile for eqch variable
...
write.csv(CartPosQuantile,"a_CartPositionQuantile.csv")
write.csv(CartVelQuantile,"a_CartVelQuantile.csv")
write.csv(PoleAngleQuantile,"a_PoleAngleQuantile.csv")
write.csv(PoleVelocityQuantile,"a_PoleVelocityQuantile.csv")
write.csv(StateSpace,"a_StateMap.csv")
write.csv(stay,"a_StateArr.csv")
write.csv(ExpectedRew1,"a_Reward1.csv")
write.csv(ExpectedRew2,"a_Reward2.csv")
write.csv(result,"a_policy.csv")
