...
list.of.packages <- c("splines", "devtools", "shinystan", "rstan", "lmerTest","gdata","foreach","rlist","doParallel","plyr")
...
init_freq=rep(0,Splitstate^3) #4
f2 = count(init_state)
init_freq[f2[,1]]=f2[,2]
init_freq = init_freq/n
write.csv(init_freq,"DATA/init_dist.csv")
```